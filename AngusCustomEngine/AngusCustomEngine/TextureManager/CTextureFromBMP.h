...
public:
	...
	// This is a BLOCKING call. Won't return until loaded into GPU
	...
	bool CreateNewTextureFromBMPFile_LoadFromDisk( std::string fileNameFullPath );	
	...
	bool CreateNewTextureFromBMPFile_CopyToGPU( bool bGenerateMIPMap );		
	// **************************************************************
	...
	bool LoadBMP2_Async( std::string fileNameFullPath );
	...
	enum eTextureLoadStatus
	{
		UNKNOWN,				// Shouldn't happen
		IS_LOADING,				// Is being copied from the hard drive
		IS_READY_TO_BE_COPIED_TO_GPU,	// Is ready to go onto the GPU
		IS_IN_GPU
	};
	eTextureLoadStatus textureLoadStatus;
